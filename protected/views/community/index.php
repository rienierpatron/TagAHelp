	            ...
	            <div class="widget-content padded">
	            	<table class="table table-filters">
		                ...
		                <?php $counter1 = 0;
		                	...
		                	<?php if($counter1 == 0){ ?>
		                		<tr>
		                			<td colspan=2 class="alert alert-danger">No Charities Found.</td>
		                		</tr>
		                	<?php } ?>
		                </tbody>
		            </table>
		                ...
		                <tbody>
		                	<?php for($counter = 0; $counter < sizeOf($community); $counter++){ ?>
	                			<?php if($community[$counter]['community_verified'] == 2){ ?>
			                		...
			                		<tr>
					                    <td class="col-md-10">
					                    	<?php echo $community[$counter]['community_name']; ?>
					                    </td>
					                    <td>
					                    	<a href="<?php echo $this->createUrl('community/details/'.$community[$counter]['community_id']); ?>" data-id="<?php echo $community[$counter]['community_id']; ?>" class="btn btn-danger pull-right">
					                    	View Info
					                    	</a>
					                    </td>
			                		</tr>
